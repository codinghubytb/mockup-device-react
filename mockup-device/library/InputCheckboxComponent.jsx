...
const InputCheckboxComponent = ({id = `range-${Math.random().toString(36).substr(2, 9)}`, value, label, onValueChanged}) => {
    const handleInputChange = (e) => {
        if (onValueChanged) {
            onValueChanged(e.target.checked); // Envoie la nouvelle valeur au parent
        }
    };
